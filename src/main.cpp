...
uint256 hashGenesisBlock("0xfa91419c4934b1792dd8f3b6752c255388c68d6bf57eb4a76b2cb176044616e7");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Funcoin: 1 days
static const int64 nTargetSpacing = 120; // Funcoin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Funcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4a475ef3d80bcaaf4a86a5029596c9852800a96eb633251addce03100677362b");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "some text that coincides with epoch";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1503667419; // main net
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085985331;

        if (fTestNet)
        {
            block.nTime    = 1503667419; //test net
            block.nNonce   = 387475369;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbc72d650178cb95e6405a667484ccf19abc398056de0907692f52a823c4cb1d0"));
